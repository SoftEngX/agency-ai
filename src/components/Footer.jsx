...
const Footer = ({theme }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="bg-slate-50 dark:bg-gray-500 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40"
    >
        ...
        >
          ...
          <div className="flex gap-2 text-sm">
            <input
              ...
              className="w-full p-3 text-sm outline-none rounded dark:text-gray-250 bg-transparent border border-gray-330 dark:border-gray-500"
            />
