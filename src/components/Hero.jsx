...
const Hero = () => {
  return (
    <div
      id="hero"
      className="flex flex-col gap-6 py-20 items-center px-4 sm:px-12 lg:px-24 xl:px-40 text-center w-full overflow-hidden text-gray-700 dark:text-white"
    >
      <motion.div
        ...
        viewport={{ once: true }}
        className="inline-flex items-center border border-gray-300 p-1.5 pr-4 rounded-full gap-2"
      >
      ...
      <motion.h1
        ...
        whileInView={{ opacity: 1, y: 0 }}
        transitsion={{ duration: 0.6, delay: 0.8 }}
        viewport={{ once: true }}
      ...
      <motion.div
        ...
        transitsion={{ duration: 0.6, delay: 2 }}
        viewport={{ once: true }}
        className="relative"
      >
